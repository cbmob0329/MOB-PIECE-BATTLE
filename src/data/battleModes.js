(function (MPB) {
  ...
  MPB.data.battleModes = [
    ...
    { id:'rank', name:'RANK MATCH', description:'ランクを上げて上位を目指す', icon:'rank', enabled:false, badge:'COMING SOON', order:2 },
    { id:'tournament', name:'TOURNAMENT', description:'勝ち抜き形式の大会に挑戦', icon:'tournament', enabled:false, badge:'COMING SOON', order:3 },
